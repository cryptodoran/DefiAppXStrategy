        ...
        <PremiumCard>
          ...
          <div className="mt-4 p-4 rounded-lg bg-elevated border border-white/5">
            ...
            <div className="flex items-start gap-3">
              <img
                src="https://pbs.twimg.com/profile_images/1836046302200430592/LQlY27MN_400x400.jpg"
                alt="Defi App"
              ...
              />
              <div className="h-10 w-10 rounded-full bg-gradient-to-br from-violet-500 to-indigo-600 hidden" />
