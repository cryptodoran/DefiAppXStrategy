      ...
      <Card className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 border-blue-500/30">
        <CardContent className="pt-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-zinc-400">Overall Brand Health</p>
              <p className="text-4xl font-bold text-white">78/100</p>
              <p className="text-sm text-green-400 mt-1">+5 from last month</p>
            </div>
            <div className="text-right">
              <p className="text-sm text-zinc-400">Position in Category</p>
              <p className="text-2xl font-bold text-white">#4</p>
              <p className="text-sm text-zinc-500">of 12 tracked competitors</p>
            </div>
          </div>
        </CardContent>
      </Card>
              ...
              <div key={index} className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-4 text-sm">
                    <span className="text-zinc-500">Competitor avg: {attr.competitorAvg}</span>
                    <span className="text-zinc-500">Target: {attr.target}</span>
              ...
              <CardContent className="pt-4">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    ...
                    <p className="text-sm text-zinc-500">{segment.size}</p>
                  </div>
                  <Badge
                    className={cn(
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                  ...
                  <div className="text-center p-2 bg-zinc-950 rounded-lg">
                    ...
                    <p className="text-xs text-zinc-500">Key Needs</p>
                  </div>
                </div>
                ...
                <div className="mt-3 space-y-2">
                  <p className="text-xs text-zinc-500">Content Preference:</p>
                  <div className="flex flex-wrap gap-1">
        ...
        <CardContent>
          <div className="space-y-6">
            {brandVoicePillars.map((pillar, index) => (
              <div key={index} className="p-4 bg-zinc-950 rounded-lg">
                <h4 className="font-medium text-white mb-1">{pillar.pillar}</h4>
                <p className="text-sm text-zinc-400 mb-4">{pillar.description}</p>
            ...
            {competitorPositioning.map((comp, index) => (
              ...
              >
                <div>
                  ...
                  <p className="text-sm text-zinc-500">"{comp.position}"</p>
                </div>
            ...
            <div className="p-4 bg-gradient-to-r from-blue-600/20 to-purple-600/20 border border-blue-500/30 rounded-lg">
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-4">
                  ...
                  <div className="text-right">
                    <p className="text-xs text-zinc-500">To Build</p>
      ...
      <Card className="bg-zinc-900 border-zinc-800">
        ...
        <CardContent>
          <div className="space-y-3">
            <div className="flex items-start gap-3 p-3 bg-zinc-950 rounded-lg">
